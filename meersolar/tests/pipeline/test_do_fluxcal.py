...
from meersolar.pipeline.do_fluxcal import *
...
@patch("meersolar.pipeline.do_fluxcal.split_casatask")
@patch("meersolar.pipeline.do_fluxcal.run_limited_memory_task", return_value=0.5)
@patch("meersolar.pipeline.do_fluxcal.get_dask_client")
@patch("meersolar.pipeline.do_fluxcal.compute")
@patch("meersolar.pipeline.do_fluxcal.os.path.exists", return_value=False)
...
@patch("meersolar.pipeline.do_fluxcal.casamstool")
@patch("meersolar.pipeline.do_fluxcal.gc.collect")
def test_get_on_off_power(mock_gc, mock_casamstool):
    mock_ms = MagicMock()
...
@patch("meersolar.pipeline.do_fluxcal.msmetadata")
@patch("meersolar.pipeline.do_fluxcal.get_on_off_power")
...
@patch("meersolar.pipeline.do_fluxcal.psutil.Process")
@patch("meersolar.pipeline.do_fluxcal.get_att_per_ant")
@patch("meersolar.pipeline.do_fluxcal.get_on_off_power")
@patch("meersolar.pipeline.do_fluxcal.get_ms_size")
@patch("meersolar.pipeline.do_fluxcal.table")
@patch("meersolar.pipeline.do_fluxcal.msmetadata")
@patch("meersolar.pipeline.do_fluxcal.limit_threads")
...
@patch("meersolar.pipeline.do_fluxcal.get_fluxcals")
@patch("meersolar.pipeline.do_fluxcal.get_bad_chans")
@patch("meersolar.pipeline.do_fluxcal.get_bad_ants")
@patch("meersolar.pipeline.do_fluxcal.run_limited_memory_task")
@patch("meersolar.pipeline.do_fluxcal.get_dask_client")
@patch("meersolar.pipeline.do_fluxcal.compute")
@patch("meersolar.pipeline.do_fluxcal.msmetadata")
@patch("meersolar.pipeline.do_fluxcal.get_ms_scan_size")
@patch("meersolar.pipeline.do_fluxcal.split_autocorr")
@patch("meersolar.pipeline.do_fluxcal.drop_cache")
@patch("meersolar.pipeline.do_fluxcal.single_ms_flag")
@patch("meersolar.pipeline.do_fluxcal.np.save")
@patch("meersolar.pipeline.do_fluxcal.os.path.exists", return_value=True)
@patch("meersolar.pipeline.do_fluxcal.os.makedirs")
...
@patch("meersolar.pipeline.do_fluxcal.drop_cache")
@patch("meersolar.pipeline.do_fluxcal.os.system")
@patch("meersolar.pipeline.do_fluxcal.os.makedirs")
@patch("casatasks.bandpass")
@patch("casatasks.split")
@patch("meersolar.pipeline.do_fluxcal.import_fluxcal_models")
@patch("meersolar.pipeline.do_fluxcal.single_ms_flag")
@patch("meersolar.pipeline.do_fluxcal.get_bad_ants", return_value=([0, 1], "0,1"))
@patch("meersolar.pipeline.do_fluxcal.get_bad_chans", return_value=[1, 2])
@patch("meersolar.pipeline.do_fluxcal.get_fluxcals", return_value=(["J0408-6545"], {"1": [1]}))
@patch("meersolar.pipeline.do_fluxcal.determine_noise_diode_cal_scan", return_value="1")
@patch("meersolar.pipeline.do_fluxcal.get_cal_target_scans", return_value=(["2"], ["1"], ["1"], [], []))
@patch("meersolar.pipeline.do_fluxcal.get_valid_scans", return_value=["1", "2"])
@patch("meersolar.pipeline.do_fluxcal.msmetadata")
@patch("meersolar.pipeline.do_fluxcal.casamstool")
@patch("meersolar.pipeline.do_fluxcal.estimate_att")
@patch("meersolar.pipeline.do_fluxcal.os.chdir")
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            0,  # Expected return value from main()
        )
    ]
)
@patch("meersolar.pipeline.do_fluxcal.np.load", return_value=("jobname", "password"))
@patch("meersolar.pipeline.do_fluxcal.sys")
@patch("meersolar.pipeline.do_fluxcal.init_logger")
@patch("meersolar.pipeline.do_fluxcal.time.sleep")
@patch("meersolar.pipeline.do_fluxcal.clean_shutdown")
@patch("meersolar.pipeline.do_fluxcal.drop_cache")
@patch("meersolar.pipeline.do_fluxcal.save_pid")
@patch("meersolar.pipeline.do_fluxcal.os.path.exists", return_value=True)
@patch("meersolar.pipeline.do_fluxcal.os.makedirs")
@patch("meersolar.pipeline.do_fluxcal.os.system")
@patch("meersolar.pipeline.do_fluxcal.run_noise_cal", return_value=(0, {"1": [1.0]}, ["/mock/file1.npy"]))
def test_main(
    mock_run_noise_cal,
    mock_system,
    mock_makedirs,
    ...
    with patch("sys.argv", argv_args):
        from meersolar.pipeline import do_fluxcal
        result = do_fluxcal.main()
        assert result == expected_return
        mock_run_noise_cal.assert_called_once()
