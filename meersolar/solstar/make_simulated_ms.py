...
def generate_ms(config_file,solar_model,source_ra,source_dec,reftime,integration_time=60,msname='fasr.ms',duration=None):
	'''
	...
	sm.setconfig(telescopename="MeerKAT",x=x,y=y,z=z,dishdiameter=dish_dia,\
		mount=['alt-az'],coordsystem='global',antname=ant_names,referencelocation=ref_location)
...
solar_model='/Data/MeerKAT_simulation_codes/simulation_codes/simulation_try/TotalTB.h5'
