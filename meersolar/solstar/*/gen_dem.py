...
def make_dem(fits_files, outfile, fov, resolution, ncpu=-1):
    """
    ...
    nf = len(wavenum)
    # normalise to dn/s
    #aia = [Map(m.data / m.exposure_time.value, m.meta) for m in aia] # Data we are providing in already normalized
