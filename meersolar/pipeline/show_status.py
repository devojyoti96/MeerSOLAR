...
def main():
    try:
        ...
        parser.add_argument("--show", action="store_true", dest="show", required=True, help="Show job status")
        parser.add_argument("--clean_old_jobs", action="store_true", dest="clean_old_jobs", default=False, help="Clean old jobs")
        if len(sys.argv) == 1:
