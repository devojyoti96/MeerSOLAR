...
profile_path=os.path.join(PREFECT_HOME, "profile.toml")
...
def cli():
    ...
    parser.add_argument("action", choices=["start", "stop", "status", "config"], help="Action to perform")
    parser.add_argument("--show-config", action="store_true", help="Show Prefect config after starting")
    ...
    if args.action == "start":
        ...
        print(f"🔍 Server running: {prefect_server_status()} at {SERVER_DASHBOARD}")
