...
.. code-block :: bash
    ...
    run-meer-meersolar </path/to/measurement_set> --workdir </path/to/work_directory> --outdir </path/to/output_product_directory>
        
Advanced run
------------
For advanced run, user is requested to first check the parameters of **run-meer-meersolar**.

.. code-block :: bash
 
    run-meer-meersolar -h
    
.. admonition:: Click here to see parameters
   :class: dropdown

   .. program-output:: run-meer-meersolar -h
...
.. code-block :: bash
    ...
    show-meersolar-ms </path/to/measurement_set>
...
.. code-block :: bash
    ...
    run-meer-meersolar </path/to/measurement_set> --solint "10s" --uvrange ">200lambda" --workdir </path/to/work_directory> --outdir </path/to/output_product_directory> 
    
2. By default for full-polar data, polarization calibration will be performed. To disable it:

.. code-block :: bash 

    run-meer-meersolar </path/to/measurement_set> --no_polcal --workdir </path/to/work_directory> --outdir </path/to/output_product_directory> 
    
    
Runs with advanced imaging paramaters 
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

1. Run pipeline to image specific target scans. Default is to use all. Users are requested to check target scan number using **show-meersolar-ms** first. Example, run the following command to image only target scans 3,8,13 from all available target scans:

.. code-block :: bash

    run-meer-meersolar </path/to/measurement_set> --target_scans 3 8 13 --workdir </path/to/work_directory> --outdir </path/to/output_product_directory> 
...
.. code-block :: bash
    ...
    run-meer-meersolar </path/to/measurement_set> --timerange 2024/06/10/09:00:00~2024/06/10/09:30:00,2024/06/10/10:15:00~2024/06/10/10:45:00 --freqrange 600~650,700~800 --workdir </path/to/work_directory> --outdir </path/to/output_product_directory> 
...
.. code-block :: bash 
    ...
    run-meer-meersolar </path/to/measurement_set> --image_timeres 120 --image_freqres 10 --workdir </path/to/work_directory> --outdir </path/to/output_product_directory> 
...
.. code-block :: bash
    ...
    run-meer-meersolar </path/to/measurement_set> --pol I --workdir </path/to/work_directory> --outdir </path/to/output_product_directory> 
...
Take a look at the **Advanced pipeline parameters** in the help page of **run-meer-meersolar**. Each parameters are self explanatory. Some examples are given below:

1. To switch on noise-diode based flux calibration:

.. code-block :: bash
    
    run-meer-meersolar </path/to/measurement_set> --no_noise_cal --workdir </path/to/work_directory> --outdir </path/to/output_product_directory> 
    
2. To switch off self-calibration:

.. code-block :: bash
    
    run-meer-meersolar </path/to/measurement_set> --no_selfcal --workdir </path/to/work_directory> --outdir </path/to/output_product_directory> 
    
3. To stop final imaging:

.. code-block :: bash
    
   run-meer-meersolar </path/to/measurement_set> --no_imaging --workdir </path/to/work_directory> --outdir </path/to/output_product_directory> 
   
4. To switch off self-calibration and final imaging

.. code-block :: bash

    run-meer-meersolar </path/to/measurement_set> --no_selfcal --no_imaging --workdir </path/to/work_directory> --outdir </path/to/output_product_directory> 
